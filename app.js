...
​
  function searchByTraits(people){
    ...
    switch(listOfTraits) {
        case "gender":
            listOfTraits = searchByGender(people);//NEED SEARCH BY GENDER FUNCTION CREATED FOR THIS CALLOUT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            break; 
        case "eye color":
            listOfTraits = searchByEyeColor(people);
            break;
        case "height":
            listOfTraits = searchByHeight(people);
            break;
        case "weight":
...
​
        if (gender === "male") {
            var foundPersons = people.filter((person)=>person.gender === "male") 
            return foundPersons; //return the result
​
        }
        else if (gender === "female") {
            var foundPersons = people.filter((person)=>person.gender === "female") 
            return foundPersons; //return the result
​
        }
        else {
